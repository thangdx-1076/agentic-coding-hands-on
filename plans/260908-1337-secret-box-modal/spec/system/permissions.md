...
Nội dung dưới đây là bản SAO NGUYÊN VĂN của `docs/vi/system/permissions.md` (đọc 2026-09-08), cộng
CHỈ phần delta mà SecretBoxModal giới thiệu. Mọi dòng gốc giữ nguyên 100% — không sửa, không xoá.
...
(`kudos-stat-list.tsx:78-81`) đã trả `null` cho toàn bộ khối thống kê (kể cả nút "Mở Secret Box")
