...
**Traceability:** F000_Homepage (F003 provisional) → SCR-home (draft) → US001-US004 (draft, local)
...
|-------------|--------|-----------------|-------------------|
| Trang chủ SAA 2025 | SCR-home (draft — số thật cấp lúc promote) | Header, hero + đếm ngược, thông tin sự kiện, CTA, nội dung Root Further, 6 thẻ giải thưởng, quảng bá Sun* Kudos, footer, widget nổi | Điều hướng tới mọi trang liên quan; (nếu đã đăng nhập) mở menu tài khoản/thông báo; đổi ngôn ngữ; mở widget hành động nhanh |
...
**Given** đang ở `/`, **When** click widget rồi chọn "Sun* Kudos", **Then** trang điều hướng tới
`/kudos`.
