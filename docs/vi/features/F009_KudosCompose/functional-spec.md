...
|-------------|--------|-----------------|-------------------|
| Viết Kudo (dialog) | SCR008_KudosCompose | Dialog che phủ `/kudos`, gồm tiêu đề, các trường Người nhận/Danh hiệu/Nội dung/Hashtag/Image/Checkbox ẩn danh, và 2 nút Hủy/Gửi | Chọn người nhận, đặt danh hiệu, viết nội dung có định dạng, gắn hashtag/ảnh, chọn gửi ẩn danh, gửi hoặc huỷ |
