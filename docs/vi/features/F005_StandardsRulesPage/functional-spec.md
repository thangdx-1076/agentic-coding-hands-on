...
| D003 | Nút "Đóng" không có entry localization trong design | vi: "Đóng" (literal từ render); EN: "Close" (suy luận UI chuẩn) | Node tên "Awards Information Navigation Links" là label mặc định của component, không phải bản dịch thật của nội dung — phân biệt tên node ≠ nội dung thật từng dẫn tới 1 lần đổi sai `site-chrome.ts`'s `awardsInfo` từ "Awards Information" → "Award Information" (2026-09-07). **ĐẢO LẠI 2026-09-10** (F003 FR-212, TC ID-21/23): giá trị đúng là số nhiều "Awards Information" — comment nguồn tại `site-chrome.ts:64-71` nay ghi rõ TC thắng tên layer Figma số ít |
