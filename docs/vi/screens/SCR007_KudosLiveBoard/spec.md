...
| E17 | 2 bảng xếp hạng | list (group) | — | — | Always (kể cả ẩn danh — dữ liệu công khai) | — | "SUNNER NHẬN QUÀ MỚI NHẤT": `public.recent_gift_recipients` (view `SECURITY DEFINER`, migration `0015`, top 10 theo `opened_at`); "SUNNER CÓ SỰ THĂNG HẠNG MỚI NHẤT": chưa có nguồn (không có bảng rank-tracking) | raw | `Chưa có dữ liệu` (mỗi bảng độc lập — rankUps luôn rỗng, giftRecipients rỗng chỉ khi chưa ai mở Secret Box) | FR-211, FR-213, FR-219, BR-012, BR-020; "SUNNER CÓ SỰ THĂNG HẠNG MỚI NHẤT" (rỗng, ngoài phạm vi), "SUNNER NHẬN QUÀ MỚI NHẤT" (dữ liệu thật từ 2026-09-10) |
