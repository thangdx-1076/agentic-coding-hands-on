...
/**
 * Pencil icon used in the Widget Button's "quick actions" trigger
 * (mm:I5022:15169;214:3839;186:1763 = MM_MEDIA_Pen, `public/home/Pen.svg`).
 * Mono icon — solid `fill="white"` replaced with `currentColor` per
 * code-rules 2a so the parent (the yellow widget pill) controls the color.
 */
