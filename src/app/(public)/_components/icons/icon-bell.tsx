...
/**
 * Notification bell icon (mm:I2167:9091;186:2101;186:2020;186:1420). Mono
 * icon downloaded as `public/home/Noti_True.svg` — inlined here per
 * code-rules 2a so the parent button controls color via `currentColor`
 * instead of the exported `fill="white"`.
 */
