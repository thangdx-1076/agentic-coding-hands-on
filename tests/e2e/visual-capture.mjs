...
async function captureVisuals() {
  ...
  const outputDir = resolve(process.cwd(), 'plans/260904-1633-login-page-google-oauth/data');
  ...
  try {
    ...
    await page.goto('http://localhost:3000/login?error=test', { waitUntil: 'networkidle' });
